...
- Prediction by Pythagorean formula and residuals.
...
```{r,echo=FALSE}
par(mfrow=c(1,2))
qqnorm(myteams$Wpct, main = "Winnign Percentage")
...
Need datafile: "all2011.csv", "fields.csv", "roster2011.csv"
...
Let's focus on the plate appearance for the great hitter *Albert Pujols* for the 2011 season. We consider only the batting plays where Albert was the hitter, and show the original state, new state, and run value variables for the first two plate appearances in this season.
...
## Career Trajectories  [30 minutes]

Need package: "car", "plyr"
